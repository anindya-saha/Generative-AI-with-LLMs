...
# https://docs.ray.io/en/latest/train/examples/lightning/lightning_cola_advanced.html
import ray
import torch
import numpy as np
...
dataset = load_dataset("glue", "cola", trust_remote_code=True)
...
class SentimentModel(pl.LightningModule):
    def __init__(self, lr=2e-5, eps=1e-8):
        ...
        self.metric = evaluate.load("glue", "cola", trust_remote_code=True)
        self.predictions = []
        self.references = []
